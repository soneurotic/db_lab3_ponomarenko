...
-- Запит 2
-- Вивести weapon_type та кількість цього зброї цього виду на персонажах, що мають level >= 40
...
-- Запит 3
-- Вивести character_name, його base_atk та max_atk зброї, якою він споряджений
